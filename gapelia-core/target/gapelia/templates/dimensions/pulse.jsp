...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8"/>
		<title>Gapelian Dimension | Pulse</title>
		...
		<script src="/static/scripts/gradient.landing-pulse.js"></script>
			...
			<div id="featured-scroller">
				...
				<div class="book-list-wrapper">
					<ul id="book-list">
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Pulse Book #01</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Pulse Book #02</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Pulse Book #03</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Pulse Book #04</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Pulse Book #05</a></div>
