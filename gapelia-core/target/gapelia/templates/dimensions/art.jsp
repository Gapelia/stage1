			...
			<div id="featured-scroller">
				...
				<div class="book-list-wrapper">
					<ul id="book-list">
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Art Book #01</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Art Book #02</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Art Book #03</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Art Book #04</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Art Book #05</a></div>
