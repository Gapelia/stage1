			...
			<div class="library-list-wrapper">
				<ul id="library-list">
					...
					<li class="library">
						...
						<span class="image-overlay"></span>
						<img src="/static/images/covers/book-thumb-11.jpg" alt=""/>
					</li>
					...
					<li class="library">
						...
						<span class="image-overlay"></span>
						<img src="/static/images/covers/book-thumb-12.jpg" alt=""/>
					</li>
					...
					<li class="library">
						...
						<span class="image-overlay"></span>
						<img src="/static/images/covers/book-thumb-13.jpg" alt=""/>
					</li>
					...
					<li class="library">
						...
						<span class="image-overlay"></span>
						<img src="/static/images/covers/book-thumb.JPG" alt=""/>
					</li>
					...
					<li class="library">
						...
						<span class="image-overlay"></span>
						<img src="/static/images/covers/book-thumb-01.jpg" alt=""/>
					</li>
					...
					<li class="library">
						...
						<span class="image-overlay"></span>
						<img src="/static/images/covers/book-thumb-02.jpg" alt=""/>
					</li>
