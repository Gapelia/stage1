...
;(function ($) {
	...
	$.adaptiveBackground = {
		run: function (options) {
			...
			// Loop over each element, waiting for it to load then finding its color, and triggering the color found event when color has been found
			$(opts.selector).each(function (index, el) {

				var $this = $(this);

				// Small helper functions which applies colors, attrs, triggers events, and check for css
