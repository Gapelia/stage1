	...
	var methods = {
		init: function (options) {
			...
			var defaults = {
				...
				// prevent mousewheel scrolling of parent elements
		...
		update: function () {
			...
			if ($this.data("horizontalScroll")) {
				...
				var mCSB_buttonUp = mCSB_scrollTools.children(".mCSB_buttonUp"), mCSB_buttonDown = mCSB_scrollTools.children(".mCSB_buttonDown"), mCustomScrollBoxH = mCustomScrollBox.height(), mCSB_containerH = mCSB_container.outerHeight();
			}
		...
		scrolling: function (mCustomScrollBox, mCSB_container, mCSB_draggerContainer, mCSB_dragger, mCSB_buttonUp, mCSB_buttonDown, mCSB_buttonLeft, mCSB_buttonRight) {
			...
			if (!$this.data("bindEvent_scrollbar_click")) {
				mCSB_draggerContainer.bind("click", function (e) {
					...
					var
					scrollToPos = (e.pageY - mCSB_draggerContainer.offset().top) * $this.data("scrollAmount"),
					target = $(e.target);
			...
			if ($this.data("mouseWheel")) {
				if (!$this.data("bindEvent_mousewheel")) {
					mCustomScrollBox.bind("mousewheel", function (e, delta) {
						...
						var
						scrollTo, mouseWheelPixels = $this.data("mouseWheelPixels"),
						...
						if ((delta > 0 && draggerPos !== 0) || (delta < 0 && draggerPos !== limit) || $this.data('preventDefault')) {
							e.preventDefault();
							e.stopImmediatePropagation();
						}
				...
				if (!$this.data("bindEvent_focusin")) {
					mCustomScrollBox.bind("focusin", function () {
						...
						if (focusedElem.is("input,textarea,select,button,a[tabindex],area,object")) {
							var
							mCSB_containerPos = mCSB_container.position().top,
		...
		scrollTo: function (scrollTo, options) {
			...
			mCSB_draggerContainer = mCSB_scrollTools.children(".mCSB_draggerContainer"),
			mCSB_dragger = mCSB_draggerContainer.children(".mCSB_dragger"),
			// contentSpeed = draggerSpeed = options.scrollInertia, scrollBeginning, scrollBeginningOffset, totalScroll, totalScrollOffset;
			contentSpeed = draggerSpeed,
			draggerSpeed = options.scrollInertia, scrollBeginning, scrollBeginningOffset, totalScroll, totalScrollOffset;
