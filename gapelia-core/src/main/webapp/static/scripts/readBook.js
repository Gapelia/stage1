var Page = (function () {
	...
	function loadBook() {
		...
		share = "";
		share += "<li><a id=\"fb-share\" href=\"javascript:window.open(facebookShare,'','width=555,height=368');void(0)\"><i class=\"ion-social-facebook\"></i></a></li>";
		share += "<li><a id=\"twitter-share\" href=\"javascript:window.open(twitterShare,'','width=550,height=257');void(0)\"><i class=\"ion-social-twitter\"></i></a></li>";
		share += "<li><a id=\"email-share\" href=\""+emailShare+"\"><i class=\"ion-email\"></i></a></li>";
		$(".share-book").html(share)

		$("#fb-share").click(function() { incrementNumBookShares(bookId, "facebook") });
		$("#twitter-share").click(function() { incrementNumBookShares(bookId, "twitter") });
		$("#email-share").click(function() { incrementNumBookShares(bookId, "email"); });
		...
		function makeBackPage() {
			...
			$.ajax({
				...
				success: function (data) {
					...
					backPage += "<h2>" + pages[0].title + "</h2><ul class=\"share-book\"><li><a id=\"fb-share\" href=\"javascript:window.open("+ facebookShare +",'','width=555,height=368');void(0)\">";
...
$vH = $(window).height();
	...
	function fluidLayout(isFirst) {
		...
		if (pages.length == 1) {
			...
			htmlToInsert += "<span class=\"txt\">Vote</span><span class=\"dont-move\">Don't move</span></a></figure><div/>";
			htmlToInsert += "<h2>" + pages[0].title + "</h2><div id=\"credits\">" + current.title + getUserFromBookId(bookId);
			htmlToInsert += "<ul class=\"share-book\"><li><a id=\"fb-share\" href=\"javascript:window.open("+ facebookShare +",'','width=555,height=368');void(0)\">";
			htmlToInsert += "<i class=\"ion-social-facebook\"></i></a></li><li><a id=\"twitter-share\" href=\"javascript:window.open("+twitterShare+",'','width=550,height=257');void(0)\">";
			htmlToInsert += "<i class=\"ion-social-twitter\"></i></a></li><li><a id=\"email-share\" href=\""+emailShare+"\"><i class=\"ion-email\"></i></a></li></ul>";
			htmlToInsert += "</div></div>";
			htmlToInsert += "</div>";
			if (getLibraryFromBook(bookId) == "") {
				if ($vW > 1024) {
