...
(function (window, document, undefined) {
	...
	_html2canvas.Util.BackgroundPosition = function (element, bounds, image, imageIndex, backgroundSize) {
		...
		var
		backgroundPosition = _html2canvas.Util.getCSS(element, 'backgroundPosition', imageIndex),
		leftPosition,
		topPosition;
	...
	_html2canvas.Util.BackgroundSize = function (element, bounds, image, imageIndex) {
		...
		var
		backgroundSize = _html2canvas.Util.getCSS(element, 'backgroundSize', imageIndex),
		width,
		height;
