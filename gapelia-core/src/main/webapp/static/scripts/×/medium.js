...
(function (w, d) {
	...
	var Medium = Medium || function (userOpts) {
		...
		_log = function (w) {
			if (settings.debug) { console.log(w); }
		},
		...
		utils = {
			...
			html: {
				...
				clean: function () {
					...
					// Removes Attributes
					var
					attsToRemove = settings.attributes.remove,
			...
			// This is a Paste Hook. When the user pastes content, this ultimately converts it into plain text before inserting the data.
