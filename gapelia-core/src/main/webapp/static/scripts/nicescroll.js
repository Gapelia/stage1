...
(function (e) {
	...
	var
	z = window.MutationObserver || window.WebKitMutationObserver || !1,
	G = {
		zindex: "auto",
		cursoropacitymin: 0,
		cursoropacitymax: 1,
	...
	M = function () {
		...
		var e = document.createElement("DIV"), b = {
		...
		for (var h = ["transform", "OTransform", "msTransform", "webkitTransform", "MozTransform"], k = 0; k < h.length; k++)
		...
		for (var h = "transition OTransition OTransition msTransition MozTransition webkitTransition KhtmlTransition".split(" "), l = " -o- -o -ms- -moz- -webkit- -khtml-".split(" "),
				q = "transitionend transitionend otransitionend oTransitionEnd msTransitionEnd webkitTransitionEnd KhtmlTransitionEnd".split(" "), k = 0; k < h.length; k++)
			if (h[k] in e.style) {
