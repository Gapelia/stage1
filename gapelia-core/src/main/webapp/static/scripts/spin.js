...
(this, function () {
		...
		lines: function (el, o) {
			...
			for (; i < o.lines; i++) {
				seg = css(createEl(), {
					position: "absolute",
					top: 1 + ~(o.width / 2) + "px",
					transform: o.hwaccel ? "translate3d(25, 25, 25)" : "",
					opacity: o.opacity,
					animation: useCssAnimations && addAnimation(o.opacity, o.trail, start + i * o.direction, o.lines) + " " + 1 / o.speed + "s linear infinite"
				});

				if (o.shadow) ins(seg, css(fill("#191919", "0 0 4px " + "#191919"), {
					top: 2 + "px"
				}));

				ins(el, ins(seg, fill(getColor(o.color, i), "0 0 1px rgba(25, 25, 25, 0.1)")));
			}
	...
	function initVML() {
		...
		Spinner.prototype.lines = function (el, o) {
			...
			if (o.shadow)
				for (i = 1; i <= o.lines; i++)
					seg(i, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=0.3)");
