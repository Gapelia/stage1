...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8"/>
		<title>Gapelian Dimension | Wonder</title>
		...
		<script src="/static/scripts/gradient.landing-wonder.js"></script>
			...
			<div id="featured-scroller">
				...
				<div class="book-list-wrapper">
					<ul id="book-list">
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Wonder Book #01</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Wonder Book #02</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Wonder Book #03</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Wonder Book #04</a></div>
						...
						<li class="book">
							<div class="book-info">
								<div class="title"><a href="#">Wonder Book #05</a></div>
