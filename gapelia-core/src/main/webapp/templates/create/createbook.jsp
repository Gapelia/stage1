...
<html lang="en">
	...
	<body class="book-creation g-body">
		...
		<!--/ Overlay — publish book /-->
		<div id="publish-overlay" class="overlay">
			<section>
				...
				<div class="wrapper">
					<a class="button a red close-modal" href="#">Cancel</a>
					<a class="button b green" id="publish-this" href="#">Publish</a>
				</div>
			</section>
		</div>
		...
		<script>
			...
			$(".close-modal").click(function (e) {
				...
				$("#publish-overlay").removeClass("open");
				e.preventDefault();
