...
<html lang="en">
	...
	<body class="book-creation g-body">
		...
		<script>
			...
			<!--Page parameterspageId,title,description,location,templateId,marginX,marginY,videoUrl,pageNumber,bookId,createdByUserId,photoUrl,photoId-->
		<script type="text/javascript">
			...
			var author="Daniel";
			$( document ).ready(function() {
				//Page loaded so book and bookID are created
				console.log("Begining to save book\n");
				$.ajax({
					...
					success: function(data) {
						console.log("successfully saved the book, its bookID is"+data+ "\n");
						bId=data;
					},
					...
					console.log("Finished actions to initiate books\n");
				});

				console.log("Initializing first 5 pages\n");

				setInterval(function() {
					console.log("autosave every minute!\n");
					autoSave()
				},60000);
			});
			var tags;
			function autoSave(){
				$.ajax({
					...
					success: function(data) {
						console.log("succesfully updated the book\n");
						bId=data;
					},
					error: function(q, status, err) {
						if(status == "timeout"){
					...
					console.log("Finished actions update books\n");
				});
			}
		</script>
		<!--//scripts /-->
