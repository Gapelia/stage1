(function() {
	...
	function iterateTextMenuButtons(callback) {
		...
		var textMenuButtons = document.querySelectorAll(".g-body .text-menu button"), i, len, node;
	...
	function triggerTextStyling(node) {
		...
		var className = node.className, tagClass, reTag;
	...
	function triggerTextSelection() {
		...
		var selectedText = root.getSelection(), range, clientRectBounds;
