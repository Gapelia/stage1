...
(function ($) {
	...
	$.Redactor.opts = {
		...
		air: false,
		airButtons: ['formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'fontcolor', 'backcolor', '|', 'fontfamily', '|', 'fontsize'],
		...
		buttonsCustom: {},
		buttonsAdd: [],
		buttons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'image', 'video', 'file', 'table', 'link', '|', 'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule', '|', 'fontfamily', '|', 'fontsize'], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		insertHtml: function (html, sync) {
			...
			} else if ($html.contents().length > 1 && currBlock || $html.contents().is('p, :header, ul, ol, div, table, blockquote, pre, address, section, header, footer, aside, article')) {
