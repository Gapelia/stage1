...
(function ($, window, undefined) {
  ...
  var pluginName = 'pep',
    ...
    defaults = {
      ...
      velocityMultiplier: 0,																		// +/- this number to modify the springiness of the object as your release it
      ...
      hardwareAccelerate: true,																		// apply the CSS3 silver bullet method to accelerate the pep object: 
