...
;(function($) {
	...
	// local refs (increase compression) // configure the drag special event
	var $event = $.event, $special = $event.special, drag = $special.drag = {
		...
		interaction: function(elem, dd) {
			var offset = $(elem)[ dd.relative ? "position" : "offset" ]() || { top: 30, left: 0 };
	...
	$event.fixHooks.touchcancel = {
		props: "clientX clientY screenX screenY".split(" "),
